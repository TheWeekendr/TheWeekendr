...
class About extends React.Component {
  render() {
    return (
      <>
        <section class="px-20 py-16 text-gray-800 text-center bg-slate-400 rounded-lg">
          <h2 class="text-3xl font-bold">Meet the Developer <span id="teamT">T</span><span id="team">eam!</span></h2>
          <div class="flex justify-center mx-auto mb-6 mt-4">
            <span class="inline-block w-80 h-1 bg-slate-500 rounded-full"></span>
            <span class="inline-block w-24 h-1 mx-1 bg-slate-500 rounded-full"></span>
            <span class="inline-block w-6 h-1 bg-slate-500 rounded-full"></span>
            <span class="inline-block w-3 h-1 mx-1 bg-slate-500 rounded-full"></span>
          </div>
          <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
            <div class="mb-6 lg:mb-0">
              <div class="bg-white block rounded-lg shadow-xl">
                ...
                <div class="p-6">
                  <h5 class="text-lg font-bold mb-1">Dustin Apodaca</h5>
                  <p class="text-gray-500 mb-4">Full-Stack Developer</p>
                  <ul class="list-inside flex mx-auto justify-center">
                    <a href="#!" class="px-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-4 h-4 text-slate-700">
                    ...
                    <a href="#!" class="px-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-4 h-4 text-slate-700">
                        <path fill="currentColor"
            ...
            <div class="mb-6 lg:mb-0">
              <div class="bg-white block rounded-lg shadow-xl">
                ...
                <div class="p-6">
                  <h5 class="text-lg font-bold mb-1">Chris Fanucchi</h5>
                  <p class="text-gray-500 mb-4">Full-Stack Developer</p>
                  <ul class="list-inside flex mx-auto justify-center">
                    <a href="#!" class="px-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-4 h-4 text-slate-700">
            ...
            <div class="">
              <div class="bg-white block rounded-lg shadow-xl">
                ...
                <div class="p-6">
                  <h5 class="text-lg font-bold mb-1">Mathew Torres</h5>
                  <p class="text-gray-500 mb-4">Full-Stack Developer</p>
                  <ul class="list-inside flex mx-auto justify-center">
                    <a href="#!" class="px-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-4 h-4 text-slate-700">
...
export default About;
        ...
        // <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow mx-auto">
        ...
        //   </p>
        //   <div class="flex items-center flex-col md:flex-row justify-around">
        //     <div class="p-4">
        //       <div class="text-center mb-4 opacity-90">
        //         <a href="#" class="block relative">
        //           <img alt="profil" src="https://www.aressecurity.co/wp-content/uploads/2022/10/DApodaca.jpeg" class="mx-auto object-cover rounded-full h-40 w-40 " />
        //         </a>
        //       </div>
